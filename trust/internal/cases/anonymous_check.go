...
func NewAnonymousCheckCase(ipRep IPReputation, cache TrustCache, salt string, maxIPFails int64) *AnonymousCheckCase {
	return &AnonymousCheckCase{ipRep: ipRep, cache: cache, salt: salt, maxIPFails: maxIPFails}
}
