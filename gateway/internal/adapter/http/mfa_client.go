...
var _ cases.MFAService = (*MFAClient)(nil)
...
func (c *MFAClient) Setup(ctx context.Context, userID, email string) (*cases.MFASetup, error) {
	...
	return &cases.MFASetup{Secret: result.Secret, OTPAuthURI: result.OTPAuthURI, Enrolled: result.Enrolled}, nil
}
