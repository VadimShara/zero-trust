...
var _ port.LoginHistoryRepository = (*LoginHistoryRepo)(nil)

func NewLoginHistoryRepo(db *pgxpool.Pool) *LoginHistoryRepo {
	return &LoginHistoryRepo{db: db}
}

func (r *LoginHistoryRepo) LastLogin(ctx context.Context, userID uuid.UUID) (*port.LoginRecord, error) {
	const q = `
...
func (r *LoginHistoryRepo) Save(ctx context.Context, record *port.LoginRecord) error {
	const q = `
