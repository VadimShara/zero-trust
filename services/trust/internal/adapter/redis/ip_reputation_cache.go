...
func (c *IPRepCache) Get(ctx context.Context, ipHash string) (*port.IPInfo, error) {
...
func (c *IPRepCache) Set(ctx context.Context, ipHash string, info *port.IPInfo, ttl time.Duration) error {
	key := fmt.Sprintf("trust:ip:%s", ipHash)
